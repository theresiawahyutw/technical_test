...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($title && $description && $status) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update tasks set title = '$title',description='$description',status = '$status' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into tasks(title,description,status) values ('$title','$description','$status')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
